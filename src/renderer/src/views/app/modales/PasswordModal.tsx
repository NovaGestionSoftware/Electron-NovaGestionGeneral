...
export default function PasswordModal({ showModalState, modalType, setShowModalState }) {
  ...
  return (
    <>
      {showModalState && modalType === "passwordModal" ? (
        <DraggableModal
          title="PasswordModal"
          isVisible={showModalState && modalType === "passwordModal"}
