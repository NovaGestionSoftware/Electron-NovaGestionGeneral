...
export default function DetalleProgramaTabla() {
  ...
  //   principal: {
  //     usuarios: {
  //       usuarios: { a: true, m: true, i: true, e: true },
  //       categorias: { a: true, m: true, i: true, e: true },
  //       cambioPassword: {},
  //     },
  //     atributos: {
  //       configuracionUsuarios: { m: true },
  //       configuracionCategorias: { m: true },
  //       configuracionSucursales: { m: true },
  //     },
  //     empresas: {
  //       empresas: { a: true, m: true, i: true, e: true },
  //       nodos: { a: true, m: true, i: true, e: true },
  //     },
  //     mantenimiento: {
