...
export default function RegistrarView() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 border bg-gray-200">
      {/* Título */}
      ...
      <div className="space-y-2">
        ...
        <section className="border rounded-md bg-gray-50 px-4 pt-2 pb-3 mb-6 space-y-2">
          <div className="w-full text-center text-sm text-gray-500 italic">(Debe coincidir con los datos de serie)</div>
